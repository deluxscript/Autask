					...
					<form className="task-form">
						...
						<div className="form-group">
							<div className='input-group date' id='datetimepicker'>
								<input type='text' name="assignedDate" className="form-control datetimepicker" placeholder="Start Date" value={this.state.projectName} onChange={e => this.handleChange(e)} />
